...
type Props = {
  ...
  onToggleSponsorship: (next: boolean) => void;
  reachBand: ReachBand;
    ...
    <div className="panel-float w-[264px] border border-ink bg-panel">
      ...
      <Section title="Layer">
        <div className="flex flex-col gap-2">
          ...
          />
          <Toggle
            label="Keluhan fasilitas (peluang CSR)"
            checked={showSponsorship}
            onChange={onToggleSponsorship}
          />
        </div>
      </Section>
          ...
          <div className="mt-3 border-t border-hair pt-2.5">
            ...
            <ul className="flex flex-col gap-2 text-xs text-ink-soft">
              <li className="flex items-center gap-2">
                ...
                />
                Tervalidasi data spasial
              </li>
              <li className="flex items-center gap-2">
                <span
                  aria-hidden="true"
                  className="h-2.5 w-2.5 shrink-0 rounded-full border-2"
                  style={{ borderColor: "#1f6f5c", background: "#ffffff" }}
                />
                Pengamatan langsung surveyor
              </li>
            </ul>
          </div>
        )}
