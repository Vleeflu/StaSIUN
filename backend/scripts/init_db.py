...
--reset menghapus isi stations, isochrones, dan pois. Ketiganya bisa diisi
...
from app.models import Isochrone, Poi, Station  # noqa: F401

PROJECT_TABLES = (Isochrone.__table__, Poi.__table__, Station.__table__)
