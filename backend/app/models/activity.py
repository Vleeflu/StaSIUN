...
class ActivityPoint(TimestampMixin, Base):
    ...
    # Penanda panen harga, terpisah dari `llm_ec_at`. 201 narasi terlanjur
    # diekstrak sebelum skema memuat bagian harga - 45 di antaranya menyebut
    # angka rupiah. Tanpa penanda sendiri, narasi yang memang tidak menyebut
    # harga akan dipanen ulang terus-menerus dan membakar kuota.
    llm_harga_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
